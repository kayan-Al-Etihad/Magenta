							...
							<div class="shop-content mt-tab-30 mb-30 mb-lg-0">
								...
								<div class="tab-content">
									<div class="tab-pane" id="grid-view">
										<div class="row">
											@foreach ($roomType as $category)
                                            <!-- Single-product start -->
                                            <div class="col-lg-4 col-md-6 category">
                                                <div class="single-product">
                                                    <div class="product-img">
                                                        <a href="{{ url('rooms/' . $category->id) }}"><img src="{{ asset('front-end-assets/img/product/1.jpg') }}" alt="" /></a>
                                                    </div>
                                                    <div class="product-info clearfix text-center">
                                                        <div class="fix">
                                                            <h4 class="post-title"><a href="{{ route('front.showCategory',$category->name) }}">{{ $category->name }}</a></h4>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
										...
										<div class="row shop-list">
											...
											<div class="col-lg-12 category">
												<div class="single-product clearfix">
													<div class="product-img">
														<a href="{{ url('rooms/' . $category->id) }}"><img src="{{ asset('front-end-assets/img/product/6.jpg') }}" alt="" /></a>
													</div>
													<div class="product-info">
														<div class="fix">
															<h4 class="post-title floatleft"><a href="{{ route('front.showCategory',$category->name) }}">{{ $category->name }}</a></h4>
														</div>
														<div class="fix mb-20">
														</div>
