...
@section('content')
   ...
   <form method="post" action="{{ route('admin.search') }}" id="form-search" onsubmit="event.preventDefault()">
      @csrf
      <input type="hidden" value="orders" name="search_kind">
      <span class="input-icon">
         <input type="number" placeholder="Search ..." class="nav-search-input" autocomplete="off" name="search" />
