...
@section('content')
   <div class="container-fluid page__container">
      <div class="page__heading d-flex align-items-center">
         ...
         <a href="{{ asset('admin/product/create') }}" class="btn btn-success ml-3">Add Product</a>
      </div>
   </div>
   ...
   <div class="container-fluid page__container">
      ...
      <div class="card-group">
         <div class="card card-body text-center">
            ...
            <div class="d-flex flex-row align-items-center">
               <div class="card-header__title m-0"> <svg xmlns="http://www.w3.org/2000/svg" width="30" height="25"
         ...
         <div class="card card-body text-center">
            <div class="d-flex flex-row align-items-center">
               <div class="card-header__title m-0"> <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
      ...
      <div class="row card-group-row">
            ...
            <div class="card card-group-row__card card-body flex-row align-items-center">
               <div class="position-relative mr-2">
                  <div class="text-center fullbleed d-flex align-items-center justify-content-center flex-column z-0">
                     <h3 class="text-success mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40"
                  ...
                  <canvas width="90" height="90" class="position-relative z-1" data-toggle="progress-chart"
                     data-progress-chart-value="12" data-progress-chart-color="danger"
         ...
         <div class="col-xl-3 col-md-6 card-group-row__col">
            <div class="card card-group-row__card card-body flex-row align-items-center">
               <div class="position-relative mr-2">
                  <div class="text-center fullbleed d-flex align-items-center justify-content-center flex-column z-0">
                     <h3 class="text-danger mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40"
      ...
      <div class="card-group">
         <div class="card card-body text-center">
            ...
            <div class="d-flex flex-row align-items-center">
               <div class="card-header__title m-0"> <svg xmlns="http://www.w3.org/2000/svg" width="30"
         ...
         <div class="card card-body text-center">
            <div class="d-flex flex-row align-items-center">
               <div class="card-header__title m-0"> <svg xmlns="http://www.w3.org/2000/svg" width="30"
                     height="30" fill="currentColor" class="bi bi-people" viewBox="0 0 16 16">
                     <path
         ...
         <div class="card card-body text-center">
            <div class="d-flex flex-row align-items-center">
               <div class="card-header__title m-0"><svg xmlns="http://www.w3.org/2000/svg" width="30"
                     height="30" fill="currentColor" class="bi bi-person-fill-add" viewBox="0 0 16 16">
                     <path
      ...
      <div class="card-group">
         <div class="card card-body text-center">
            ...
            <div class="d-flex flex-row align-items-center">
               <div class="card-header__title m-0"><svg xmlns="http://www.w3.org/2000/svg" width="30"
                     height="30" fill="currentColor" class="bi bi-bag-fill" viewBox="0 0 16 16">
                     <path
         ...
         <div class="card card-body text-center">
            <div class="d-flex flex-row align-items-center">
               <div class="card-header__title m-0"> <svg xmlns="http://www.w3.org/2000/svg" width="30"
                     height="30" fill="currentColor" class="bi bi-bag-heart" viewBox="0 0 16 16">
                     <path fill-rule="evenodd"
         ...
         <div class="card card-body text-center">
            <div class="d-flex flex-row align-items-center">
               <div class="card-header__title m-0"> <svg xmlns="http://www.w3.org/2000/svg" width="16"
                     height="16" fill="currentColor" class="bi bi-bag-plus-fill" viewBox="0 0 16 16">
                     <path fill-rule="evenodd"
                        d="M10.5 3.5a2.5 2.5 0 0 0-5 0V4h5v-.5zm1 0V4H15v10a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V4h3.5v-.5a3.5 3.5 0 1 1 7 0zM8.5 8a.5.5 0 0 0-1 0v1.5H6a.5.5 0 0 0 0 1h1.5V12a.5.5 0 0 0 1 0v-1.5H10a.5.5 0 0 0 0-1H8.5V8z" />
         ...
         <div class="col-lg-5">
            ...
            <div class="card">
                  ...
                  <div class="list-group list-group-small list-group-flush">
                     @foreach ($popular_products as $pro)
                        <div class="list-group-item d-flex align-items-center px-0">
                           <div class="mr-3 flex"> <i class="material-icons icon-18pt icon-muted">contacts</i>
                              {{ $pro->product_name }}</div>
                           <div class="mr-3 text-dark-gray">{{ $pro->created_at }}</div>
                           <div><a href="">&dollar;{{ $pro->sale_price }}</a></div>
                        </div>
                     @endforeach
                  </div>
               </div>
               ...
               <div class="card-footer text-center">
                  <a class="text-muted" href="/admin/product">View All ({{ $available_products }})</a>
               </div>
         ...
         <div class="col-lg-7">
            ...
            <div class="card">
               ...
               <div class="card-header card-header-large bg-white d-flex align-items-center">
                  <div class="flatpickr-wrapper flex">
                     <div>
                        <h4 class="card-header__title">Not Aroved :</h4>
                     </div>
                  </div>
                  <i class="material-icons icon-muted">help_outline</i>
               </div>
               ...
               <div class="card-body py-0">
                  <div class="list-group list-group-small list-group-flush">
                     @foreach ($feedbacks as $feedback)
                        <div class="py-2 d-flex align-items-center px-0" style="border-bottom: 1px solid #eee;">
                           <div class="mr-3 flex">{{ $feedback->feedback }}</div>
                           <div class="mr-3 text-dark-gray">{{ $feedback->created_at->diffForHumans() }}</div>
                           <div>
                              <form class="" method="post"
                                 action="{{ route('feedback.destroy', $feedback->id) }}">
                                 @csrf
                                 @method('DELETE')
                                 <input type="submit" class="btn btn-danger btn-sm mx-0 float-start PY-3 px-3"
                                    value="Delete" />
                              </form>

                              <a href="{{ route('feedback.updateStatus', $feedback->id) }}"
                                 class="btn btn-sm btn-primary">aproved</a>
                           </div>
                        </div>
                     @endforeach
               ...
               <div class="card-footer text-center">
                  <a class="text-muted" href="/admin/feedback">View All ({{ $feedbacksCount }})</a>
               </div>
