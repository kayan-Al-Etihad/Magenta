                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="single-product">
                                ...
                                <div class="product-content text-right" dir="rtl">
                                    <h3><a href="{{route('product-detail',$product->slug)}}">{{$product->title_ar}}</a>
                                    </h3>
                                    {{-- @php
                            ...
                            <ul class="categor-list">
                                ...
                                <li><a href="{{route('product-grid',$cat_info->slug)}}">{{$cat_info->title_ar}}</a>
                                    <ul style="margin-right: 1.5rem;margin-left:0px">
                                        ...
                                        <li><a
                                                href="{{route('product-sub-grid',[$cat_info->slug,$sub_menu->slug])}}">{{$sub_menu->title_ar}}</a>
                                        </li>
                                        @endforeach
                                    </ul>
                                </li>
                        ...
                        <div class="single-widget category">
                            ...
                            <ul class="categor-list">
                                ...
                                <li><a href="{{route('product-grid',$cat_info->slug)}}">{{$cat_info->title}}</a>
                                    <ul style="margin-right: 0px;margin-left:1.5rem">
                                        @foreach($cat_info->child_cat as $sub_menu)
                                        <li><a
                                                href="{{route('product-sub-grid',[$cat_info->slug,$sub_menu->slug])}}">{{$sub_menu->title}}</a>
                                        </li>
                                        @endforeach
                                    </ul>
                                </li>
