                                    ...
                                    <div class="shop-top" dir="rtl">
                                        ...
                                        <ul class="view-mode">
                                            ...
                                            @if($category->is_parent == 1)
                                                <li class="active"><a href="{{route('product-sub-grid', [ $category->slug,$sub->slug])}}"><i class="fa fa-th-large"></i></a></li>
                                                <li><a href="{{route('product-sub-list', [ $category->slug,$sub->slug])}}"><i class="fa fa-th-list"></i></a></li>
                                            @else
                                                <li class="active"><a href="{{route('product-grid', $category->slug)}}"><i class="fa fa-th-large"></i></a></li>
                                                <li><a href="{{route('product-list', $category->slug)}}"><i class="fa fa-th-list"></i></a></li>
                                            @endif
                                            @endif
                                        </ul>
                                    </div>
